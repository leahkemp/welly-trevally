...
```{r out.width = "70%", fig.align = "center", fig.cap = "Trevally ($\\textit{Pseudocaranx georgianus}$) illustration by Leah Kemp."}
library(knitr)
...
leaflet() %>%
  ...
  mapshot(file = "../images/04-generalIntroduction/annualDist.png", vwidth = 2600, vheight = 3500)
```
...
leaflet() %>%
  ...
  addPolygons(data = annualJuvDist, 
              ...
              fillColor = "#54ff9f") %>%
  addProviderTiles(providers$Esri.WorldImagery, options = providerTileOptions(opacity = 0.7)) %>%
  mapshot(file = "../images/04-generalIntroduction/juvenileDist.png", vwidth = 2600, vheight = 3500)
```
...
leaflet() %>%
  ...
  addPolygons(data = annualSpawningDist, 
              ...
              fillColor = "#54ff9f") %>%
  addProviderTiles(providers$Esri.WorldImagery, options = providerTileOptions(opacity = 0.7)) %>%
  mapshot(file = "../images/04-generalIntroduction/spawningDist.png", vwidth = 2600, vheight = 3500)
```

```{r distribution, out.width = "30%", fig.align = "center", fig.cap = "Annual distribution of $\\textit{P. georgianus}$ in New Zealand by life stage as indicated in green.", fig.show = "hold"}
library(knitr)
knitr::include_graphics(c("../imagesFinal/04-generalIntroduction/annualDist.png", "../imagesFinal/04-generalIntroduction/juvenileDist.png", "../imagesFinal/04-generalIntroduction/spawningDist.png"))
```
...
leaflet() %>%
  ...
  addPolygons(data = springDist, 
              ...
              fillColor = "#54ff9f") %>%
  addProviderTiles(providers$Esri.WorldImagery, options = providerTileOptions(opacity = 0.7)) %>%
  mapshot(file = "../images/04-generalIntroduction/springDist.png", vwidth = 2600, vheight = 3500)
```
...
leaflet() %>%
  ...
  addPolygons(data = summerDist, 
              ...
              fillColor = "#54ff9f") %>%
  addProviderTiles(providers$Esri.WorldImagery, options = providerTileOptions(opacity = 0.7)) %>%
  mapshot(file = "../images/04-generalIntroduction/summerDist.png", vwidth = 2600, vheight = 3500)
```
...
leaflet() %>%
  ...
  addPolygons(data = autumnDist, 
              ...
              fillColor = "#54ff9f") %>%
  addProviderTiles(providers$Esri.WorldImagery, options = providerTileOptions(opacity = 0.7)) %>%
  mapshot(file = "../images/04-generalIntroduction/autumnDist.png", vwidth = 2600, vheight = 3500)
```
...
leaflet() %>%
  ...
  addPolygons(data = winterDist, 
              ...
              fillColor = "#54ff9f") %>%
  addProviderTiles(providers$Esri.WorldImagery, options = providerTileOptions(opacity = 0.7)) %>%
  mapshot(file = "../images/04-generalIntroduction/winterDist.png", vwidth = 2600, vheight = 3500)
```

```{r seasonalDistribution, out.width = "100%", fig.cap = "Seasonal distribution of $\\textit{P. georgianus}$ in New Zealand as indicated in green."}
library(knitr)
knitr::include_graphics("../imagesFinal/04-generalIntroduction/seasonsDist.png")
```
...
```{r fishingEffort, out.width = "100%", fig.align = "center", fig.cap = "$\\textit{P. georgianus}$ Quota Management Areas and yearly fishing effort for the three major commercially fished Quota Management Areas. The total allowable commercial catch (TACC) is indicated in red."}
library(knitr)
...
read.csv("../data/04-generalIntroduction/tacc.csv", stringsAsFactors = FALSE, header = TRUE, na.strings=c("")) %>%
  knitr::kable(col.names = c("Quota Management Area", "Years above TACC", "Percentage of TACC caught (1986-2017)", "Percentage of TACC caught (2007-2017)"),
               caption = "Historical fishing effort by Quota Management Area (QMA).",
               booktabs = TRUE,
               align = "r",
               linesep = "") %>%
  kable_styling(font_size = 8, position = "center", latex_options = "hold_position") %>%
  column_spec(column = 2:4, width = "1in")
```
